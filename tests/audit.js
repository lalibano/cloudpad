...
(async () => {
  ...
  d.getElementById("signin-btn").click(); await tick(100);
  T("R1 cloud signin w/o lib", d.getElementById("auth-error").textContent.length > 5, d.getElementById("auth-error").textContent.slice(0, 60));
  d.getElementById("magic-btn").click(); await tick(100);
  T("R2 magic w/o lib", d.getElementById("auth-error").textContent.length > 5);
